...
public class Block extends Actor
{
     ...
     * @param debug (optional) - An optional parameter which if true turns on debugging statements.  Defaults to false.
     */
    ...
    protected void createDisplayImage() {
        /*The Ratio of width:height for letters in greenfoot is 44:100 = 0.44 (determined experimentally on my machine
         * with the code below 
       
        String testString = "";
        for (int i=0; i<=9; i++) {
            GreenfootImage singleLetter = new GreenfootImage( Integer.toString(i),100,Color.RED,Color.BLACK);        
            System.out.println(Integer.toString(i) + " - " + Integer.toString(singleLetter.getWidth()));
        }
        */  
